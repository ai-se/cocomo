<small>_This file is part of cocomo. To know more, view the source code [counts.py](../src/counts.py) or read our [home](https://github.com/ai-se/cocomo) page._</small>
